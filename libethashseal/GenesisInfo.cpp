...
#include "genesis/btcbamMainNetwork.cpp"
...
#include "genesis/test/btcbamTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::btcbamMainNetwork: return c_genesisInfoBtcbamMainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::btcbamTestNetwork: return c_genesisInfoBtcbamTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::btcbamMainNetwork: return c_genesisStateRootBtcbamMainNetwork;
    case Network::btcbamTestNetwork: return c_genesisStateRootBtcbamTestNetwork;
